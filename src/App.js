...
const touchDown = event => {
  if(event.target.textContent === 'Home Touchdown'){
    setHomeScore(homeScore + 6)
  }
  if(event.target.textContent === 'Away Touchdown'){
    setAwayScore(awayScore + 6)
  }
}

const fieldGoal = event => {
  if(event.target.textContent === 'Home Field Goal'){
    setHomeScore(homeScore + 3)
  }
  if(event.target.textContent === 'Away Field Goal'){
